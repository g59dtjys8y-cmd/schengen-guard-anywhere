...
- **Trip list with status** — a "+" to add a new trip; a "DONE" stamp once a trip is in the past, or an Active or Planned tag otherwise; the 4 most-recently-completed stays stay visible, anything older collapses into one expandable "Earlier trips" group; edit, remove, or add a note to any trip inline.
